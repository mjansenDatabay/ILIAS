...
final class DBUpdateSteps implements ilDatabaseUpdateSteps
{
    ...
    private const int SUBJECT_LENGTH = 128;
    ...
    public function step_1(): void
    {
        ...
        $this->database->addPrimaryKey(self::TABLE, ['namespace', 'subject', 'keyword']);
    }
    ...
    public function step_2(): void
    {
        ...
        if ($this->database->tableColumnExists(self::TABLE, 'subject')) {
            return;
        }

        $this->database->addTableColumn(self::TABLE, 'subject', [
            'type' => ilDBConstants::T_TEXT,
            'length' => self::SUBJECT_LENGTH,
            'notnull' => true,
            'default' => ''
        ...
        $this->database->dropPrimaryKey(self::TABLE);
        $this->database->addPrimaryKey(self::TABLE, ['namespace', 'subject', 'keyword']);
    }
}
