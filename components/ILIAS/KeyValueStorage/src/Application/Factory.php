...
interface Factory
{
     ...
     *
     * @throws StorageNotAvailableException if no provider contributed the backend
     */
    ...
    /**
     * {@see session()} with the current actor resolved through {@see SubjectResolver}.
     *
     * @throws StorageNotAvailableException if no provider contributed the backend
     */
    ...
    /**
     * {@see persistent()} with the current actor resolved through {@see SubjectResolver}.
     *
     * @throws StorageNotAvailableException if no provider contributed the backend
     */
