...
final readonly class NamespacedStorage implements Storage
{
    ...
    public function has(string $key): bool
    {
        ...
        return $this->port->has($this->namespace, $key, $this->subject);
    }
    ...
    public function get(string $key, mixed $default = null): mixed
    {
        ...
        $encoded = $this->port->read($this->namespace, $key, $this->subject);
        if ($encoded === null) {
            return $default;
        }
    ...
    public function set(string $key, mixed $value): void
    {
        ...
        $this->port->write($this->namespace, $key, $this->value_codec->encode($value), $this->subject);
    }
    ...
    public function delete(string $key): void
    {
        ...
        $this->port->remove($this->namespace, $key, $this->subject);
    }

    public function clear(): void
    {
        $this->port->clearNamespace($this->namespace, $this->subject);
    }
}
