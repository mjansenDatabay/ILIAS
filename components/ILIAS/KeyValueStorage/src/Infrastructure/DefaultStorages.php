...
/**
 * Maps the consumer {@see Storages} API to {@see SubjectAwareStorages} with fixed subject states.
 */
final readonly class DefaultStorages implements Storages
{
    public function __construct(private SubjectAwareStorages $inner)
    {
    }

    public function storage(StorageNamespace $namespace): Storage
    {
        return $this->inner->storageWithSubject($namespace, Subject::absent());
    }
