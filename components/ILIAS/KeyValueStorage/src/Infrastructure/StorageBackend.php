 ...
 *           lifetime through {@see \ILIAS\KeyValueStorage\Application\Factory::session()} /
 *           {@see \ILIAS\KeyValueStorage\Application\Factory::persistent()}. Backend
 *           providers use {@see StorageProviderFactory::session()} /
