...
{
    public function testPurgesAuthenticatedUserSubject(): void
    {
        ...
        new AuthenticatedSubjectPurge($subject_purge)->purgeForUserId(42);
    }

    public function testIgnoresNonPositiveUserId(): void
    {
        $subject_purge = $this->createMock(SubjectPurge::class);
        $subject_purge->expects($this->never())->method('purge');

        new AuthenticatedSubjectPurge($subject_purge)->purgeForUserId(0);
    }
}
