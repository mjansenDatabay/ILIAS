// fau: fixTinyInExam - replaced all 'javascript:;' with '#' in href attributes
// 		The original hrefs cause connection in SafeExamBrowser 2 on netpoint
//		It seems that the event handlers don't stop the default and the href is not found
// fau.
