	...
	tinymce.PluginManager.add('ilimgupload', function (editor, baseurl) {
		...
		function showDialogSuccess(server_data) {
			...
			function onSubmitForm() {
				var id = "#" + win.find('#img_file')[0]._id,
					fu = $(id).find("input"),
					fd = new FormData();
...
console.log(id, fu[0].files[0], parameters.obj_type, parameters.obj_id);
				$.ajax({
					url: baseurl + '/imgupload.php',
					type: 'POST',
					xhr: function() {
			...
			win = editor.windowManager.open({
				...
				onPostRender: function() {
					var w = this, id = "#" + w.find('#img_file')[0]._id, fu = $(id).find("input");
						...
						fu.on("change", function(e) {
							...
							for (var i = 0, f; f = files[i]; i++) {
								...
								reader.onload = (function(file) {
									return function (e) {
										$("#previewfile-body").prepend($(['<img class="thumb" src="', e.target.result, '" title="', escape(file.name), '"/>'].join("")).css({height: "100px", width: "auto"}));
									};
								})(f);
