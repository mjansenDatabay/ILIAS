	...
	tinymce.PluginManager.add('ilimgupload', function (editor, baseurl) {
		...
		function showDialogSuccess(server_data) {
			...
			function onSubmitForm() {
				var id = "#" + win.find('#img_file')[0]._id, fu = $(id).find("input"), fd = new FormData();
			...
			function srcChange(e) {
				...
				if (this.value() != "") {
					$("#previewsrc-body").prepend($(['<img class="thumb" src="', this.value(), '"/>'].join("")).css({height: "100px", width: "auto"}));
				} else {
