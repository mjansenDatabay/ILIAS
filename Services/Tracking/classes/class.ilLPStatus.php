...
class ilLPStatus
{
    ...
    protected static function raiseEvent($a_obj_id, $a_usr_id, $a_status, $a_percentage)
    {
        global $DIC;
     ...
     * @return bool
     */
    public static function writeStatus($a_obj_id, $a_user_id, $a_status, $a_percentage = false, $a_force_per = false)
    {
        global $DIC;
